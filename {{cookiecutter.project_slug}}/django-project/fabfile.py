...
project_slug = '{{cookiecutter.project_slug}}' # This will become the slug in the URL. Ex: http://apps.kbia.org/the-slug-here
build_folder = 'baked/{{cookiecutter.project_slug}}' 
